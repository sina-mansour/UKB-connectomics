...
if [ "${atlas_space}" == "fsLR" ]; then
	...
	left_fsaverage164_sphere="${ukb_subjects_dir}/${ukb_subject_id}/fsaverage164/surf/lh.sphere"
	...
	right_fsaverage164_sphere="${ukb_subjects_dir}/${ukb_subject_id}/fsaverage164/surf/rh.sphere"
